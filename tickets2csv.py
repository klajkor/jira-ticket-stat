...
jql_string_R6_R61 = 'project = CCP AND (fixVersion in ("Release 6.0") OR fixVersion in ("Release 6.1")) ORDER BY type DESC,  key ASC'
...
jql_string_sprint = 'issueKey in (CCP-1610,CCP-1677,CCP-1431,CCP-1543,CCP-1571,CCP-1584,CCP-1607,CCP-1655,CCP-1665,CCP-1672,CCP-1683,CCP-1699,CCP-1732)'
jql_string_estimation = 'project = CCP AND type in (Story) AND labels in (refined) AND Sprint is EMPTY AND status not in (Done) AND ("Epic Link" not in (CCP-34, CCP-101) OR "Epic link" is EMPTY) ORDER BY Fixversion ASC, rank ASC'
...
if __name__ == '__main__':
    ...
    issues_in_proj = jira_stat_lib.export_issues_to_csv(jira, jql_string_R6_R61, all_epics, ticket_list_file)
    print("#####----------------------------------#####")
